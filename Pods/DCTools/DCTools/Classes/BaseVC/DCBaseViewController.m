...
- (void)showNetFailureView {
    ...
    label.textColor = RGBA_COLOR(40, 40, 40,1);
    ...
    button.layer.borderColor = RGBA_COLOR(40, 40, 40,1).CGColor;
    button.layer.borderWidth = 1;
    [button setTitle:@"重新加载" forState:UIControlStateNormal];
    [button setTitleColor:RGBA_COLOR(40, 40, 40,1) forState:UIControlStateNormal];

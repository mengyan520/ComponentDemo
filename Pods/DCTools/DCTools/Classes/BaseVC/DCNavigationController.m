...
#import "DCCommon.h"
@interface DCNavigationController ()<UIGestureRecognizerDelegate, UINavigationControllerDelegate>
...
//    // 在这里统一设置UINavigationBar的风格，背景、字体、大小等等
    UIImage *navigationBarImage = [UIImage dc_buildImageWithColor:UIColorFromHexValue(0xC02A16)];
